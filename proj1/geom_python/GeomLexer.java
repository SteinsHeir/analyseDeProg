...
public class GeomLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "WS", "MAIN", "FUNC", "CONS", "LPAR", "RPAR", 
			...
			"DQUOTE", "STRING", "CHAR", "NUMERIC", "DIGIT", "LETTER"
		};
	}
	...
	public GeomLexer(CharStream input) {
		super(input);
